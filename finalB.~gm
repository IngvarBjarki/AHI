...
Ex2(t).. EXCECUTIVE_OVERVIEW('DPC',t) =e= power(0.95, ord(t)-1)*(sum(i, ALPHA(i)/1000 * sum(n, h(n,i)*r(n,i,t)))+ sum(i, BETA(i)/(1000*1000) * sum(n, h(n,i)*h(n,i) * r(n,i,t))) + sum(j, y(j,t)*c(j)/1000));
