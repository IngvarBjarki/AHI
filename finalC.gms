...
s0(i,t) 'amount of timber i used to make products'
...
timber_used(s,i,t) ..  sum(j, y(s,j,t)*table2(j, i)) =e= s0(i,t);
prod_starved(s,i,t) .. sum(n, r(n, i,t)*h(n, i)) =g= s0(i,t);
Sold_Prod(s,j,t) .. sum((l,k), q(l,j)*u(l,j,k,t)) =l= y(s,j,t);
timber_bought(s,i,t) .. b(i,t) =e= sum(n, r(n, i,t)*h(n, i));

//=================== ONLY BUY ONE NUMBER OF BARGERS FOR EACH TIMBER i ========================
Barges_buy(s,i,t) ..  sum( n,r(n,i,t)) =E= 1;
Barges_sell(s,j, k,t) .. sum(l, u(l, j, k,t)) =E= 1;
...
PULP_Bal(s,p3,t) .. sum((l,k), u(l,p3,k,t)*q(l,p3)) + PAP_Pro*y(s,"PAP",t) =l= y(s,P3,t);


// =====PROFIT(OLD OBJECTIVE FUNCTION)=======//

nPROFIT(s,t).. Pr(s,t) =e=  RHO(s,t)*(sum((k,j), (GAMMA(j,k)/1000) * sum(l, q(l,j)*u(l,j,k,t)))
- sum((k,j), (DELTA(j,k)/(1000*1000)) * sum(l, q(l,j)*q(l,j) * u(l,j,k,t))/power(demand_growth(j), ord(t)-1)))   //Amount sold times sellingprice
                    ...
                    + sum(i, (b(i,t)-s0(i,t))*ALPHA(i)/1000)                                                                                        //Amount of extra material times its selling price
